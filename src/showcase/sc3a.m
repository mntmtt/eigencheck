fprintf(" ----- Example 3a: Another problem... -----\n\n");
fprintf("Clusterized eigenvalues are the worst nightmare for Newton's method.\n\n");

eigenvalues = [2, 2.5, 3, 10, 11, 13];
geo_mults = [2, 1, 2, 1, 1, 2];
algebraic_mults = [2, 1, 2, 2, 1, 2];
...
disp(eig_results);
fprintf("Expected geometric multiplicity results: [2, 1, 2, 1, 1, 2]\n");
disp(geo_results);
fprintf("Expected algebraic multiplicity results: [2, 1, 2, 2, 1, 2]\n");
disp(alg_results);
